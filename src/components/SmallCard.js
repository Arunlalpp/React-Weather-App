  ...
  return (
		<>
			<div className="bg-white rounded-lg mt-2 lg:w-[52%] lg:ml-[12.5%] w-9xl ml-[3.3%]">
				...
				<div className="md:grid grid-cols-4 md:gap-4 md:p-5 p-3 flex flex-row gap-2 overflow-auto overflow-y-hidden scrollbar-hide scroll-smooth">
					{cardData.map((cardItem) => {
						return (
							<div className="md:min-w-[0] min-w-[40vw]">
								...
								<div className="mt-3">
									<p className="md:text-[14px] text-[14px] hover:text-blue-500 cursor-pointer">
										{cardItem.title}
									</p>
								</div>
							</div>
