			...
			<div className="bg-white rounded-lg mt-2 lg:w-[52%] lg:ml-[12.5%] w-9xl ml-[3.3%]">
				...
				<div className="md:grid md:grid-cols-4 gap-4 p-5 hidden ">
					<div>
						...
						<div className="mt-2">
							<p className="md:text-[14px] text-[10px] hover:text-blue-500 cursor-pointer">
								This Plant in Australia Covers An Area Four Times the Size of
								New Delhi!
							</p>
						</div>
					</div>
					<div>
						...
						<div className="mt-2">
							<p className="md:text-[14px] text-[10px] hover:text-blue-500 cursor-pointer">
								Brazil Flooding Kills Dozens, Leaves Thousands Homeless
							</p>
						</div>
					</div>
					<div>
						...
						<div className="mt-2">
							<p className="md:text-[14px] text-[10px] hover:text-blue-500 cursor-pointer">
								Places Getting Dusty: Little-Known Potential Impact of Climate
								Change
							</p>
						</div>
					</div>
					<div>
						...
						<div className="mt-2">
							<p className="md:text-[14px] text-[10px] hover:text-blue-500 cursor-pointer">
								WATCH: Latest India Weather Forecast: June 6
							</p>
						</div>
					</div>
				</div>
				<div className="p-5 md:hidden">
					<div>
						...
						<div className="mt-2">
							<p className="md:text-[14px] text-[16px] hover:text-blue-500 cursor-pointer">
								This Plant in Australia Covers An Area Four Times the Size of
								New Delhi!
							</p>
						</div>
				...
				<button className="md:hidden block ml-6 mb-4 mt-2 rounded-full px-6 py-2.5 bg-[#1B4DE4] text-white font-medium text-xs leading-tight  hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
					Show more
				</button>
			</div>
		</>
